  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-amber-100">Selamat Datang</h1>
        <p className="text-sm text-amber-700 mt-1">Masuk ke MajaCraft</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/lupa-password" className="text-xs text-amber-600 hover:text-amber-400">Lupa password?</Link>
          </div>
          <div className="relative">
      ...
      <p className="text-center text-sm text-amber-700">
        Belum punya akun?{" "}
        <Link href="/daftar" className="text-amber-400 hover:text-amber-300 font-semibold">Daftar Sekarang</Link>
      </p>
    </div>
  );
}
